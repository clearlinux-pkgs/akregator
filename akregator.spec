...
Version  : 24.12.1
Release  : 109
URL      : https://download.kde.org/stable/release-service/24.12.1/src/akregator-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/akregator-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/akregator-24.12.1.tar.xz.sig
...
%setup -q -n akregator-24.12.1
cd %{_builddir}/akregator-24.12.1
pushd ..
cp -a akregator-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736734773
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakregatorinterfaces.so.6.3.1
/V3/usr/lib64/libakregatorprivate.so.6.3.1
...
/usr/lib64/libakregatorinterfaces.so.6.3.1
/usr/lib64/libakregatorprivate.so.6
/usr/lib64/libakregatorprivate.so.6.3.1
