...
%prep
%setup -q -n akregator-22.12.3
cd %{_builddir}/akregator-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677802006
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakregatorinterfaces.so.5.22.3
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.22.3
