...
Version  : 24.12.3
Release  : 113
URL      : https://download.kde.org/stable/release-service/24.12.3/src/akregator-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/akregator-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/akregator-24.12.3.tar.xz.sig
...
%setup -q -n akregator-24.12.3
cd %{_builddir}/akregator-24.12.3
pushd ..
cp -a akregator-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742518429
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakregatorinterfaces.so.6.3.3
/V3/usr/lib64/libakregatorprivate.so.6.3.3
...
/usr/lib64/libakregatorinterfaces.so.6.3.3
/usr/lib64/libakregatorprivate.so.6
/usr/lib64/libakregatorprivate.so.6.3.3
