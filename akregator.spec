...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akregator-22.08.0.tar.xz
...
%prep
%setup -q -n akregator-22.08.0
cd %{_builddir}/akregator-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661565721
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakregatorinterfaces.so.5.21.0
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.21.0
