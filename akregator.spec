...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/akregator-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/akregator-24.02.0.tar.xz.sig
...
%prep
%setup -q -n akregator-24.02.0
cd %{_builddir}/akregator-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710454745
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakregatorinterfaces.so.6.0.0
/V3/usr/lib64/libakregatorprivate.so.6.0.0
...
/usr/lib64/libakregatorinterfaces.so.6.0.0
/usr/lib64/libakregatorprivate.so.6
/usr/lib64/libakregatorprivate.so.6.0.0
