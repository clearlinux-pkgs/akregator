...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/akregator-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/akregator-22.04.3.tar.xz.sig
...
%prep
%setup -q -n akregator-22.04.3
cd %{_builddir}/akregator-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657590177
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akregator-22.04.3/.krazy.license %{buildroot}/usr/share/package-licenses/akregator/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/akregator-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akregator/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/akregator-22.04.3/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/akregator/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/akregator-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/akregator/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/akregator-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akregator/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akregator-22.04.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/akregator-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/akregator-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akregator-22.04.3/plugins/mk4storage/metakit/license.terms %{buildroot}/usr/share/package-licenses/akregator/4f42a9e708f812e067f2d87a77362c80f5f9c2bb
pushd clr-build
%make_install
popd
%find_lang akregator
...
/usr/lib64/libakregatorinterfaces.so.5.20.3
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.20.3
