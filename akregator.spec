...
%setup -q -n akregator-25.04.1
cd %{_builddir}/akregator-25.04.1
pushd ..
cp -a akregator-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747189212
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakregatorinterfaces.so.6.4.1
/V3/usr/lib64/libakregatorprivate.so.6.4.1
...
/usr/lib64/libakregatorinterfaces.so.6.4.1
/usr/lib64/libakregatorprivate.so.6
/usr/lib64/libakregatorprivate.so.6.4.1
