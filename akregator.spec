...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/akregator-21.12.0.tar.xz
...
%prep
%setup -q -n akregator-21.12.0
cd %{_builddir}/akregator-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639694833
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akregator-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akregator/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/akregator-21.12.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/akregator/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/akregator-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akregator/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akregator-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/akregator-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/akregator-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akregator/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akregator-21.12.0/plugins/mk4storage/metakit/license.terms %{buildroot}/usr/share/package-licenses/akregator/4f42a9e708f812e067f2d87a77362c80f5f9c2bb
pushd clr-build
%make_install
popd
%find_lang akregator
...
/usr/lib64/libakregatorinterfaces.so.5.19.0
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.19.0
