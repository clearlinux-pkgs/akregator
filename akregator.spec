...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/akregator-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/akregator-22.12.0.tar.xz.sig
...
%prep
%setup -q -n akregator-22.12.0
cd %{_builddir}/akregator-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670786937
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakregatorinterfaces.so.5.22.0
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.22.0
