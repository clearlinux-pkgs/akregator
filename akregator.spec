...
Version  : 18.12.3
Release  : 4
URL      : https://download.kde.org/stable/applications/18.12.3/src/akregator-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/akregator-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/akregator-18.12.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552023609
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakregatorinterfaces.so.5.10.3
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.10.3
