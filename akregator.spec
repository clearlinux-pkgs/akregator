...
Version  : 22.08.3
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.08.3/src/akregator-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/akregator-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/akregator-22.08.3.tar.xz.sig
...
%prep
%setup -q -n akregator-22.08.3
cd %{_builddir}/akregator-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667930769
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akregator-%{version}/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akregator/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9 || :
...
/usr/lib64/libakregatorinterfaces.so.5.21.3
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.21.3
