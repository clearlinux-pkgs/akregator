...
Version  : 23.08.2
Release  : 72
URL      : https://download.kde.org/stable/release-service/23.08.2/src/akregator-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/akregator-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/akregator-23.08.2.tar.xz.sig
...
%prep
%setup -q -n akregator-23.08.2
cd %{_builddir}/akregator-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697470003
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakregatorinterfaces.so.5.24.2
/V3/usr/lib64/libakregatorprivate.so.5.24.2
...
/usr/lib64/libakregatorinterfaces.so.5.24.2
/usr/lib64/libakregatorprivate.so.5
/usr/lib64/libakregatorprivate.so.5.24.2
